...
import { BRAND, NAV_ITEMS } from '../../../shared/constants';
...
export class Header {
  ...
  icons: any = {
    ...
    sparkles:
      'M12 2l1.8 4.2L18 8l-4.2 1.8L12 14l-1.8-4.2L6 8l4.2-1.8L12 2Zm7 9l.9 2.1L22 14l-2.1.9L19 17l-.9-2.1L16 14l2.1-.9L19 11Zm-14 4l.9 2.1L8 18l-2.1.9L5 21l-.9-2.1L2 18l2.1-.9L5 15Z',
    ...
    phone:
      'M22 16.9v3a2 2 0 0 1-2.2 2 19.7 19.7 0 0 1-8.6-3.1 19.4 19.4 0 0 1-6-6A19.7 19.7 0 0 1 2.1 4.2 2 2 0 0 1 4 2h3a2 2 0 0 1 2 1.7c.1.8.3 1.5.6 2.2a2 2 0 0 1-.5 2.1L8 9a16 16 0 0 0 7 7l1-1.1a2 2 0 0 1 2.1-.5c.7.3 1.4.5 2.2.6a2 2 0 0 1 1.7 1.9Z',
